...
> tutorial. The full in-game wiki is reachable from the tutorial's **Open Wiki** button
> or from **`/ai panel`** → Settings → Identity tab. Reopen the tutorial with **`/ai tutorial`**.
